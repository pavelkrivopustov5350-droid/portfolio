...
export const profile: Profile = {
  ...
  about: {
    ...
    facts: [
      { value: "150–200K", label: "заявок в месяц — масштаб направлений в fintech" },
      { value: "5 лет", label: "в маркетинге, аналитике и росте" },
      { value: "B1", label: "английский" },
      { value: "2024", label: "«Аналитик данных», Карпов курсы" },
    ],
    footnote:
      "Образование: ВолГУ — информатика и вычислительная техника (бакалавр). Москва, готов к командировкам. Свой автомобиль, права категории B.",
  },
