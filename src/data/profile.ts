...
export const profile: Profile = {
  ...
  about: {
    ...
    ai: "Продвинуто использую LLM и AI-инструменты как рабочий инструмент — от исследования и генерации гипотез до написания кода, автоматизации процессов и анализа результатов.",
  },
